...
export async function generateMetadata({ params }: { params: { city?: string } }): Promise<Metadata> {
  ...
  return {
    title: `Вакансии в компании СТП Групп ${seoCityTitle ? `${seoCityTitle}` : ''} | Работа на спецтехнике`,
    description: `Актуальные вакансии для машинистов и водителей спецтехники ${!isDefaultCity ? seoCityDescription : ''}. Работа на автокранах, экскаваторах, самосвалах. Стабильная зарплата.`,
    ...
    openGraph: {
      title: `Вакансии в компании СТП Групп ${seoCityTitle ? `${seoCityTitle}` : ''}`,
      description: `Работа для машинистов и водителей спецтехники ${!isDefaultCity ? seoCityDescription : ''}. Стабильные условия и своевременные выплаты.`,
      type: "website",
      locale: "ru_RU",
      // images: [
      //     {
      //         url: `${SITE_URL}/og-vacancies.jpg`,
      //         width: 1200,
      //         height: 630,
      //         alt: `Вакансии в компании СТП Групп ${seoCityTitle ? `в ${seoCityTitle}` : ''}`,
      //     },
      // ],
    },
    robots: {
    ...
    alternates: {
      canonical: `${SITE_URL}/${!isDefaultCity ? citySlug : ''}/vacancies`,
    },
  };
}
...
function replaceCityPlaceholders(text: string, citySlug: CitySlug): string {
  ...
  return text.replace(/\[city\]/g, cityPrepositional)
             .replace(/\[city-dative\]/g, cityDative)
             .replace(/\[city-genitive\]/g, cityGenitive);
}
...
export default function VacanciesPage({ params }: { params: { city?: string } }) {
  ...
  const cityPrepositional = getCityInPrepositionalCase(citySlug);
  const cityDative = getCityInDativeCase(citySlug);
  const cityNominative = cityDative
  const seoCityTitle = getSeoCityTitle(citySlug);
  ...
  const vacanciesStructuredData = {
    ...
    "@type": "ItemList",
    "name": `Вакансии в компании СТП Групп ${seoCityTitle ? `${seoCityTitle}` : ''}`,
    "description": `Актуальные вакансии для работы на спецтехнике ${!isDefaultCity ? cityPrepositional : ''}`,
    "numberOfItems": 4,
    "itemListElement": [
      {
        "@type": "ListItem",
        ...
        "item": {
          ...
          "jobLocation": {
            ...
            "address": {
              "@type": "PostalAddress",
              "addressLocality": !isDefaultCity ? cityNominative : "Москва"
            }
          },
      ...
      <div className="container">
        ...
        <section className="pb-4" itemScope itemType="https://schema.org/ItemList">
          <h1 
            ...
            itemProp="name"
          >
            Вакансии {!isDefaultCity ? cityPrepositional : 'в компании'}
          </h1>
          
          <meta itemProp="description" content={`Актуальные вакансии для работы на спецтехнике ${!isDefaultCity ? cityPrepositional : ''}`} />
              ...
              <div itemScope itemType="https://schema.org/JobPosting">
                ...
                <div itemProp="jobLocation" itemScope itemType="https://schema.org/Place">
                  <div itemProp="address" itemScope itemType="https://schema.org/PostalAddress">
                    <meta itemProp="addressLocality" content={!isDefaultCity ? cityNominative : "Москва"} />
                  </div>
                </div>
