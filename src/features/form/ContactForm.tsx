    ...
    <form onSubmit={handleSubmit} aria-labelledby="contact-form-heading" aria-describedby="contact-form-subheading" noValidate>
      ...
      <div className="relative w-full mt-[12px]">
        ...
        <textarea
          ...
          className="px-[15px] placeholder:text-white py-[8px] md:text-[16px] text-[14px] rounded-[12px] bg-white w-full min-h-[120px] text-black outline-none relative z-2 max-h-[200px]"
